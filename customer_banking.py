...
def main():
    ...
    print(f"Savings Account: Interest Earned = {interest_earned}, Updated Balance = {updated_savings_balance}")
    ...
    print(f"CD Account: Interest Earned = {interest_earned}, Updated Balance = {updated_cd_balance}")
